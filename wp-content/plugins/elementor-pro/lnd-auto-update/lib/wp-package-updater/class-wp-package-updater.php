...
if ( ! class_exists( 'LND_Auto_Updater' ) ) {

	class LND_Auto_Updater {
		...
		public function __construct(
			...
			if ( ! class_exists( 'Puc_v4_Factory' ) ) {
				require $this->package_path . 'lnd-auto-update/lib/plugin-update-checker/plugin-update-checker.php';
			}
		...
		public function load_textdomain() {
			$i10n_path = trailingslashit( basename( $this->package_path ) ) . 'lnd-auto-update/lib/wp-update-migrate/languages';
		...
		public function add_admin_scripts( $hook ) {
			...
			if ( $condition ) {
				...
				$ver_js = filemtime( $this->package_path . 'lnd-auto-update/lib/wp-package-updater/js/main' . $js_ext );
				$params = array(
					'action_prefix' => 'wppu_' . $this->package_id,
					'ajax_url'      => admin_url( 'admin-ajax.php' ),
				);

				wp_enqueue_script( 'wp-package-updater-script', $this->package_url . 'lnd-auto-update/lib/wp-package-updater/js/main' . $js_ext, array( 'jquery' ), $ver_js, true );
		...
		public function print_license_form_theme_page() {
			...
			require_once $this->package_path . 'lnd-auto-update/lib/wp-package-updater/templates/theme-page-license.php';
		...
		public function print_license_under_plugin( $plugin_file = null, $plugin_data = null, $status = null ) {
			...
			require_once $this->package_path . 'lnd-auto-update/lib/wp-package-updater/templates/plugin-page-license-row.php';
		...
		protected function get_license_form() {
			...
			require_once $this->package_path . 'lnd-auto-update/lib/wp-package-updater/templates/license-form.php';
