...
require_once plugin_dir_path( __FILE__ ) . 'lnd-auto-update/lib/wp-package-updater/class-wp-package-updater.php';

$prefix_updater = new LND_Auto_Updater (
  'http://update.lojanegociosdigital.com.br/',
